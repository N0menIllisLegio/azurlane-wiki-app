...
namespace azurlane_wiki_app.ShipPage
{
    public class DropItem
    {
        ...
        public string ToolTip_4 { get; set; }
        public string ToolTip_5 { get; set; }
        public string ToolTip_6 { get; set; }
        public string ToolTip_7 { get; set; }
        public string ToolTip_8 { get; set; }
        public string ToolTip_9 { get; set; }
        public string ToolTip_10 { get; set; }
        public string ToolTip_11 { get; set; }
        public string ToolTip_12 { get; set; }
        public string ToolTip_13 { get; set; }
    }
}